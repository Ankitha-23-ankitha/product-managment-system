...
export default function AddModal({ products, setProducts, setShowAddModal, setShow }) {
            ...
            <div className='bg-white p-4 rounded-lg w-[300px] space-y-4 opacity-100'>
                ...
                <div className='flex flex-col space-y-2'>
                    ...
                    <input 
                        ...
                        onChange={(e)=>setCurrent(curr=>{return({...curr, name: e.target.value})})}
                    />
                    ...
                    <input 
                        ...
                        className='border p-2 rounded' 
                        onChange={(e)=>setCurrent(curr=>{return({...curr, category: e.target.value})})}
                    />
                ...
                <div className='flex justify-between pt-4'>
                    ...
                    <button className='px-4 py-2 bg-blue-500 text-white rounded' onClick={()=>handleAdd()}>Add</button>
                </div>
            </div>
        </div>
    )
